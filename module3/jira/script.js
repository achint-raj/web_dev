...
let ticketArr = [];  //which helps in filtering because we need to store the tickets information that's why array is used. @important
...
for (let i = 0; i < toolBoxColors.length; i++) {
    toolBoxColors[i].addEventListener("click", function () {
        ...
        let filteredArr = [];   //using this array because for filtering with the help of ticket colours.
