...
// const mail = "rahix19584@sceath.com";
// const password = "99340110";
...
//  }).then(function()
//  {
//      return waitAndClick(".fl-button-wrap.fl-button-width-auto.fl-button-left a.fl-button");
// //     let waitloginPromise = page.waitForSelector(".fl-button-wrap.fl-button-width-auto.fl-button-left a.fl-button");
// //     return waitloginPromise;
// // }).then(function()
// // {
// //     let loginPromise = page.click(".fl-button-wrap.fl-button-width-auto.fl-button-left a.fl-button");
// //     return loginPromise;
// }).then(function()
// {
...
// }).then(function()
// {
//     console.log("Login successful ho gaaya");
// }).then (function()
// {
//     let waitPromise = page.waitForSelector(".topic-name");
//     return waitPromise;
// }).then(function()
// {
//   let clickPromise = page.click(".topic-name");
//   return clickPromise;
// }).then(function(){
