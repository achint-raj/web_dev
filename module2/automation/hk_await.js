...
//     await page.waitAndClick('button[data-analytics="LoginPassword"]',page);
//     await page.waitAndClick('[data-automation="algorithms"]',page);
...
//     let questionsArr = page.evaluate(function(){
//         let arr = [];
